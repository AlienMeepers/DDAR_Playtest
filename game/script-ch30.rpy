...
label ch30_noskip:
    ...
    if persistent.current_monikatopic != 0:
        ...
        call expression "ch30_" + str(persistent.current_monikatopic) from _call_expression_6
    jump ch30_loop
    return
...
label ch30_autoload:
    ...
    if persistent.monika_reload <= 4:
        call expression "ch30_reload_" + str(persistent.monika_reload) from _call_expression_7
    else:
